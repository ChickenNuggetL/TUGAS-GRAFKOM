...
public class MouseInput {
    ...
    public void forceCenterMouse(boolean xd, Window window){
        if (xd) {
            GLFW.glfwSetInputMode(window.window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
            //GLFW.glfwSetCursorPos(window.window, (float)window.getWidth()/2, (float)window.getHeight()/2);
