...
public class BroomHatter {
    ...
    public void create(){
        ...
        LeftHand.Sphere((ArrayList<Object>) BroomHatter.get(0).getChildObject(), 50, 90, 50, 255/255f, 255/255f,0/255f);
        RightHand.Sphere((ArrayList<Object>) BroomHatter.get(0).getChildObject(), 50, 90, 50, 255/255f, 255/255f,0/255f);
        ...
        BroomHatter.get(0).getChildObject().get(2).translateObject(100/1000f, -55/1000f, 0f);//tangan kanan
        BroomHatter.get(0).getChildObject().get(3).translateObject(-100/1000f, -55/1000f, 0f);//tangan kiri
