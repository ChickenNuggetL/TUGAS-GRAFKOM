...
public class BroomHatter {
    ...
    public void create(){
        ...
        stick.Sphere((ArrayList<Object>) BroomHatter.get(0).getChildObject(),20, 150f, 20, 181/255f, 101/255f,29/255f);
        ...
        BroomHatter.get(0).getChildObject().get(7).translateObject(0f, -90/1000f, -15/100f);
